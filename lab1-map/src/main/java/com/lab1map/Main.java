...
public class Main {
    public static void main(String[] args) {
        ...
        Disciplina disc1 = new Disciplina("Métodos Avançados de Programação ", prof1, horario1);
        Disciplina disc2 = new Disciplina("Redes de Computadores", prof2, horario2);
        Disciplina disc3 = new Disciplina("Calculo 3", prof3, horario3);
